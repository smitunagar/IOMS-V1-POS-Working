module.exports = [
"[project]/.next-internal/server/app/api/waste/kpis/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/waste/kpis/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const query = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$wasteService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["KPIQuerySchema"].parse({
            window: window === 'today' || window === 'week' || window === 'month' ? window : 'week'
        });
        const kpis = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$wasteService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getOwnerKPIs"])(query);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b2f07f2f._.js.map