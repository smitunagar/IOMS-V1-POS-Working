module.exports = [
"[project]/.next-internal/server/app/api/ai-allergen/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/ai-allergen/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
async function generateAllergenList(input) {
...
async function POST(request) {
    try {
        ...
        const result = await generateAllergenList({
            dishName: name,
            aiHint
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: error?.message || 'Failed to generate allergens'
        }, {
            status: 500
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__10f373f0._.js.map