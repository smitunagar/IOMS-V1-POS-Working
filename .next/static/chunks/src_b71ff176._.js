...
"[project]/src/lib/procurementWorkflowService.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class ProcurementWorkflowService {
    ...
    async autoGenerateQuotationRequest(alert) {
        ...
        if (existingRequest) {
            console.log("[Procurement] Quotation request already exists for ".concat(alert.itemName));
            return;
        }
        const quotationRequest = {
            id: "qr_".concat(Date.now(), "_").concat(Math.random().toString(36).substr(2, 9)),
            itemId: alert.itemId,
        ...
        console.log("[Procurement] Auto-generated quotation request for ".concat(alert.itemName, " (").concat(quotationRequest.id, ")"));
    ...
    async addQuotationResponse(response) {
        const quotationResponse = {
            ...response,
            id: "qr_response_".concat(Date.now(), "_").concat(Math.random().toString(36).substr(2, 9)),
    ...
    async requestOwnerApproval(quotationRequestId, selectedQuotationId) {
        ...
        const selectedQuotation = quotationRequest === null || quotationRequest === void 0 ? void 0 : quotationRequest.responses.find((r)=>r.id === selectedQuotationId);
        ...
        if (selectedQuotation.totalPrice <= this.workflowSettings.autoApprovalLimit) {
            const autoApproval = {
                id: "approval_auto_".concat(Date.now()),
                quotationRequestId,
                selectedQuotationId,
        ...
        const ownerApproval = {
            id: "approval_".concat(Date.now(), "_").concat(Math.random().toString(36).substr(2, 9)),
            quotationRequestId,
            selectedQuotationId,
            totalAmount: selectedQuotation.totalPrice,
            justification: "Best quote from ".concat(selectedQuotation.vendorName, " for ").concat(quotationRequest.itemName),
            requestedBy: 'SupplySync Bot',
            requestedAt: new Date().toISOString(),
            status: 'pending',
            urgencyLevel: quotationRequest.urgencyLevel
    ...
    async generatePurchaseOrder(approval) {
        try {
            ...
            const selectedQuotation = quotationRequest === null || quotationRequest === void 0 ? void 0 : quotationRequest.responses.find((r)=>r.id === approval.selectedQuotationId);
            if (!quotationRequest || !selectedQuotation) {
                console.error('[Procurement] Cannot find quotation data for purchase order');
                return null;
            }
            const orderNumber = "PO-".concat(new Date().getFullYear(), "-").concat(String(this.purchaseOrders.size + 1).padStart(4, '0'));
            const purchaseOrder = {
                id: "po_".concat(Date.now(), "_").concat(Math.random().toString(36).substr(2, 9)),
                orderNumber,
            ...
            console.log("[Procurement] Purchase Order ".concat(orderNumber, " generated for ").concat(quotationRequest.itemName));
    ...
    async sendVendorQuotationEmail(quotationRequest, vendorId) {
        console.log("[Email] Quotation request sent to vendor ".concat(vendorId, " for ").concat(quotationRequest.itemName));
        return true;
    }
    async sendOwnerApprovalEmail(approval) {
        console.log("[Email] Owner approval request sent for ".concat(approval.totalAmount, " EUR"));
        return true;
    }
    async sendPurchaseOrderToVendor(purchaseOrder) {
        console.log("[Email] Purchase order ".concat(purchaseOrder.orderNumber, " sent to ").concat(purchaseOrder.vendorName));
    ...
    selectVendorsForQuotation(category) {
        ...
        return vendorCategories[category === null || category === void 0 ? void 0 : category.toLowerCase()] || [
            'vendor_001',
            'vendor_002'
        ];
    }
        ...
        for (const approval of this.ownerApprovals.values()){
            if (approval.status === 'pending') {
                ...
                if (now - requestTime > overdueThreshold) {
                    console.log("[Procurement] Overdue approval reminder for ".concat(approval.id));
                // Send reminder email
                }
            }
        }
    ...
    constructor(){
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "quotationRequests", new Map());
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "ownerApprovals", new Map());
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "purchaseOrders", new Map());
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "workflowSettings", void 0);
        this.initializeWorkflowSettings();
        this.setupAutoMonitoring();
    }
}
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(ProcurementWorkflowService, "instance", void 0);
const procurementWorkflowService = ProcurementWorkflowService.getInstance();
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/app/apps/supply-sync/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$procurementWorkflowService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/procurementWorkflowService.ts [app-client] (ecmascript)");
...
function SupplySyncPage() {
    ...
    // Context integration
    const { isActive: isSupplySyncActive, setSupplySyncActive, addInventoryAlert } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$SupplySyncContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSupplySync"])();
    ...
    const [managementVendors, setManagementVendors] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const [quotationRequests, setQuotationRequests] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [ownerApprovals, setOwnerApprovals] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const [smartRecommendations, setSmartRecommendations] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    // Modal states
    const [showAddVendorModal, setShowAddVendorModal] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [showQuotationModal, setShowQuotationModal] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const [showVendorDetails, setShowVendorDetails] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    // Form states
    const [newVendorData, setNewVendorData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        name: '',
        category: '',
        contactInfo: {
            email: '',
    ...
    const [newVendorProductInput, setNewVendorProductInput] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    ...
    const loadProcurementData = async ()=>{
        try {
            ...
            const quotations = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$procurementWorkflowService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["procurementWorkflowService"].getAllQuotationRequests();
            const approvals = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$procurementWorkflowService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["procurementWorkflowService"].getAllOwnerApprovals();
            const orders = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$procurementWorkflowService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["procurementWorkflowService"].getAllPurchaseOrders();
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "space-y-4",
                                                children: vendors.map((vendor)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: inventoryItems.filter((item)=>item.urgencyLevel === 'critical' || item.urgencyLevel === 'high').map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$alert$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Alert"], {
                                                        className: "".concat(item.urgencyLevel === 'critical' ? 'border-red-200 bg-red-50' : 'border-yellow-200 bg-yellow-50'),
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$triangle$2d$alert$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__AlertTriangle$3e$__["AlertTriangle"], {
                                                                className: "h-4 w-4 ".concat(item.urgencyLevel === 'critical' ? 'text-red-600' : 'text-yellow-600')
                                                            }, void 0, false, {
                                                                fileName: "[project]/src/app/apps/supply-sync/page.tsx",
                                                                lineNumber: 563,
                                                                columnNumber: 23
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                ...
                                                                children: [
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                        className: "w-3 h-3 rounded-full ".concat(item.urgencyLevel === 'critical' ? 'bg-red-500' : item.urgencyLevel === 'high' ? 'bg-yellow-500' : item.urgencyLevel === 'medium' ? 'bg-blue-500' : 'bg-green-500')
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/src/app/apps/supply-sync/page.tsx",
                                                                        lineNumber: 667,
                                                                        columnNumber: 25
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "space-y-4",
                                        children: [
                                            quotationRequests.map((quotation)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            quotationRequests.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "space-y-4",
                                        children: [
                                            ownerApprovals.map((approval)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "p-4 border rounded-lg",
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "flex justify-between items-start",
                                                        children: [
                                            ...
                                            ownerApprovals.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "text-center py-8",
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$circle$2d$check$2d$big$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__CheckCircle$3e$__["CheckCircle"], {
                                                        className: "h-12 w-12 mx-auto text-gray-400 mb-4"
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "space-y-4",
                                        children: [
                                            purchaseOrders.map((order)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "p-4 border rounded-lg",
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "flex justify-between items-start",
                                                        children: [
                                            ...
                                            purchaseOrders.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "text-center py-8",
                                                children: [
...
_s(SupplySyncPage, "UW1B11olXtv7vDytk+kOreOlFHU=", false, function() {
    return [
...
_c = SupplySyncPage;
var _c;
__turbopack_context__.k.register(_c, "SupplySyncPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_b71ff176._.js.map