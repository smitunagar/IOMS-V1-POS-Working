    ...
    const demoQuotationRequests: QuotationRequest[] = [
      {
        ...
        unit: 'kg',
        urgencyLevel: 'high',
        preferredVendors: ['v5', 'v9'], // Kaufland, Edeka
    ...
    const demoOwnerApprovals: OwnerApproval[] = [
      {
        ...
        urgencyLevel: 'medium',
        totalAmount: 425,
        justification: 'Fresh chicken restock for upcoming weekend demand'
      }
    ];
        ...
        items: [
          {
            ...
            unitPrice: 8.50,
            totalPrice: 425,
            specifications: 'Grade A free-range chicken'
          }
        ],
        subtotal: 425,
        tax: 80.75,
    ...
    try {
      ...
      if (response.ok) {
        ...
        const quotationRequest = {
          ...
          specifications: result.data.specifications || 'Standard quality requirements',
          budgetLimit: result.data.estimatedBudget,
          status: 'draft',
          responses: [],
