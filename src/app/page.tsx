          ...
          <div className="flex flex-col sm:flex-row items-center justify-between h-auto sm:h-16 py-4 sm:py-0 space-y-4 sm:space-y-0">
            <div className="flex items-center space-x-2 sm:space-x-4">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900">IOMS Marketplace</span>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-4">
              ...
              {currentUser && (
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-xs sm:text-sm font-medium">{currentUser.email}</span>
                </div>
              )}
            </div>
          </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        <div className="bg-white rounded-xl p-4 sm:p-6 lg:p-8 shadow-sm border">
          <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-4 mb-4">
            <div className="w-10 h-10 sm:w-12 sm:h-12 lg:w-16 lg:h-16 bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl flex items-center justify-center">
              <span className="text-white font-bold text-lg sm:text-xl lg:text-2xl">🛒</span>
            </div>
            <div className="text-center sm:text-left">
              <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900">Business Apps Marketplace</h1>
              <p className="text-sm sm:text-base text-gray-600">Discover and integrate powerful business applications</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 lg:gap-6">
          <div className="bg-white rounded-lg p-3 sm:p-4 lg:p-6 shadow-sm border">
            <div className="flex items-center justify-center mb-2">
              <Users className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-blue-600" />
            </div>
            <div className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900">2,847</div>
          ...
          <div className="bg-white rounded-lg p-3 sm:p-4 lg:p-6 shadow-sm border">
            ...
            <div className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900">15,392</div>
          ...
          <div className="bg-white rounded-lg p-3 sm:p-4 lg:p-6 shadow-sm border">
            ...
            <div className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900">98.5%</div>
          ...
          <div className="bg-white rounded-lg p-3 sm:p-4 lg:p-6 shadow-sm border">
            ...
            <div className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900">4.9</div>
          ...
          <div className="flex flex-col space-y-4 sm:space-y-0 sm:flex-row sm:space-x-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6">
          {filteredApps.map((app: AppMetadata) => (
            <div key={app.id} className="bg-white rounded-xl shadow-sm border p-4 sm:p-6 transition-all duration-300 hover:shadow-lg hover:scale-105">
              <div className="flex flex-col sm:flex-row sm:items-start justify-between mb-4 space-y-2 sm:space-y-0">
                <div className="flex items-center space-x-3">
                  <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-r from-blue-500 to-purple-500 rounded-lg flex items-center justify-center">
                    <span className="text-white font-bold text-xs sm:text-sm">{app.icon}</span>
                  </div>
                  <div>
                    <h3 className="font-semibold text-sm sm:text-base text-gray-900">{app.name}</h3>
                    <p className="text-xs sm:text-sm text-gray-600">{app.category}</p>
                  </div>
                </div>
              ...
              <p className="text-gray-600 text-xs sm:text-sm mb-4 line-clamp-2">{app.description}</p>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between space-y-2 sm:space-y-0">
                <div className="flex items-center space-x-1">
                  ...
                  <span className="text-xs sm:text-sm font-medium text-gray-700">v{app.version}</span>
                  <span className="text-xs sm:text-sm text-gray-500">by {app.author}</span>
                </div>
                {app.route ? (
                  <Link
                    href={app.route}
                  ...
                  <span className="inline-flex items-center justify-center px-3 sm:px-4 py-2 bg-gray-300 text-gray-500 text-xs sm:text-sm font-medium rounded-lg cursor-not-allowed">
                    Coming Soon
                  </span>
                )}
              </div>
